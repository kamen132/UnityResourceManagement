...
public delegate void OnCallBackBoolString(bool a, string b);
...
public delegate void OnCallBackWWW(UnityWebRequest a);
public delegate void OnCallBackSTexture2D(string path, UnityEngine.Texture2D tex);
...
public delegate void OnCallBackSAssetBundle(string a, UnityEngine.AssetBundle b);
...
public delegate void OnCallBackII_T(int a, int b, float c, float d, float e, float f);
